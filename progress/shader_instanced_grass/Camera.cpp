...
void Camera::SetProjectionToOrtho(float left, float right, float bottom, float top, float zNear, float zFar) //in pixels
{
...
void Camera::ResetVectors(glm::vec3 newPos, glm::vec3 newTarget, glm::vec3 newUp) //NEW_TARGET & NEW_UP DON'T WORK
{
    cameraPos = newPos;
